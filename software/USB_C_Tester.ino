// ===================================================================================
// Project:   USB-C Power Delivery Tester based on ATtiny25/45/85
// Version:   v1.2
// Year:      2020 - 2021
...
// Description:
// ------------
// Simple USB-C Power Delivery Tester based on ATtiny25/45/85 and INA219. The
// device measures voltage, current, power, energy, capacity and displays the
// values on an OLED screen. You can switch between different screens by pressing
// the SET button.
//
// References:
// -----------
...
uint16_t INA_readCurrent(void) {
  ...
  if(result > 32767) result = 65535 - result;   // make nagtive currents positive
  return result;                                // return result
}
